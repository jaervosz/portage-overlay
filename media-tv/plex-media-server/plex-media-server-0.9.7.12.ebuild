...
KEYWORDS="-* ~x86 ~amd64"
SRC_URI="x86?	( http://plex.r.worldssl.net/PlexMediaServer/0.9.7.12.407-db37d6d/plexmediaserver_0.9.7.12.407-db37d6d_i386.deb )
	amd64?	( http://plex.r.worldssl.net/PlexMediaServer/0.9.7.12.407-db37d6d/plexmediaserver_0.9.7.12.407-db37d6d_amd64.deb )"
SLOT="0"
LICENSE="PMS-License"
IUSE=""
