...
KEYWORDS="-* ~x86 ~amd64"
SRC_URI="x86?	( http://downloads.plexapp.com/plex-media-server/0.9.8.4.125-ffe2a5d/plexmediaserver_0.9.8.4.125-ffe2a5d_i386.deb )
	amd64?	( http://downloads.plexapp.com/plex-media-server/0.9.8.4.125-ffe2a5d/plexmediaserver_0.9.8.4.125-ffe2a5d_amd64.deb )"
SLOT="0"
LICENSE="PMS-License"
IUSE=""
