...
KEYWORDS="-* ~x86 ~amd64"
SRC_URI="x86?	( http://plex.r.worldssl.net/PlexMediaServer/0.9.7.9.375-d056f10/plexmediaserver_0.9.7.9.375-d056f10_i386.deb )
	amd64?	( http://plex.r.worldssl.net/PlexMediaServer/0.9.7.9.375-d056f10/plexmediaserver_0.9.7.9.375-d056f10_amd64.deb )"
SLOT="0"
LICENSE="PMS-License"
IUSE=""
