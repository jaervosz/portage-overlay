#mythweb-0.22_p22763-path-list.patchh Copyrighr 1999-2010 Gentoo Foundation
...
src_prepare() {
	...
	#epatch "${FILESDIR}/${PN}-video-streaming.patch"
	epatch "${FILESDIR}/${P}-carppout-debug.patch"
	epatch "${FILESDIR}/${P}-mp4-streaming.patch"
	epatch "${FILESDIR}/${P}-path-list.patch"
	epatch "${FILESDIR}/${P}-tmpl-error.patch"
	epatch "${FILESDIR}/${P}-myth-video-streaming.patch"
}
...
hmythweb-0.22_p22763-path-list.patch
