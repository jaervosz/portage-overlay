...
HOMEPAGE="http://docs.puppetlabs.com/mcollective/"
...
src_install() {
	...
	dodir /usr/share/mcollective/mcollective/application
	...
	insinto /usr/share/mcollective/mcollective/application
	cd ${S}/plugins/mcollective/application
	doins *.rb
